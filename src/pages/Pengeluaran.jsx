...
export default function Pengeluaran() {
  ...
  const handleDeleteFromEdit = async () => {
    const ok = window.confirm('Yakin ingin menghapus pengeluaran ini?')
    if (!ok) return
  ...
  return (
    <div>
      <h1 className="mb-6 text-2xl font-semibold">Pengeluaran</h1>
      ...
      {showEdit && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="w-full max-w-md rounded-2xl bg-white p-6">
            <h2 className="mb-4 text-xl font-semibold">Edit Pengeluaran</h2>
